...
b=0;b<d.length;b++)if(a.href=d[b].src,/(twilio\.js)|(twilio\.min\.js)$/.test(a.pathname))return{host:a.host,minified:/\.min\.js$/.test(a.pathname)}}(),h="/twilio.min.js",l=document.getElementsByTagName("script")[0],e=document.createElement("script");e.type="text/javascript";e.src="//"+"static.twilio.com"+"/libs/twiliojs/refs/3716fe1"+h;e.onload=e.onreadystatechange=function(){e.readyState&&"loaded"!=e.readyState||(f.run(Twilio.Device),k.run(Twilio.EventStream))};l.parentNode.insertBefore(e,
